  ...
  async updateWorkHistory(context, payload) {
    ...
    return axios.post(
      `${config.apiBaseUrl}/update_work_history`,
      {
        ...
        // work_stage: payload.workStage,
        // work_stage_additional_info: payload.workStageAdditionalInfo,
        // project: payload.project,
        // work_stage_started: payload.startTime,
        // scheduled_start_time: payload.scheduledStartTime,
        // work_stage_ended: payload.endTime,
